...
export class AssetsApi extends BaseAPI {
     ...
     * Get details of an asset
     * @summary Get details of an asset
     * @param {GetAssetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AssetsApi
     */
    public getAsset(requestParameters: GetAssetRequest, options?: AxiosRequestConfig) {
     ...
     * Get a list of assets
     * @summary Get a list of assets
     * @param {ListAssetsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AssetsApi
     */
    public listAssets(requestParameters: ListAssetsRequest = {}, options?: AxiosRequestConfig) {
