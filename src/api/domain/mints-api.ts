 ...
 * @export
 * @interface GetMintRequest
 */
export interface GetMintRequest {
    /**
 ...
 * @export
 * @interface GetMintableTokenDetailsByClientTokenIdRequest
 */
export interface GetMintableTokenDetailsByClientTokenIdRequest {
    /**
 ...
 * @export
 * @interface ListMintsRequest
 */
export interface ListMintsRequest {
    /**
...
export class MintsApi extends BaseAPI {
     ...
     * Get details of a mint with the given ID
     * @summary Get details of a mint with the given ID
     * @param {GetMintRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MintsApi
     */
    public getMint(requestParameters: GetMintRequest, options?: AxiosRequestConfig) {
     ...
     * Get details of a mintable token with the given token address and token ID
     * @summary Get details of a mintable token with the given token address and token ID
     * @param {GetMintableTokenDetailsByClientTokenIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MintsApi
     */
    public getMintableTokenDetailsByClientTokenId(requestParameters: GetMintableTokenDetailsByClientTokenIdRequest, options?: AxiosRequestConfig) {
     ...
     * Get a list of mints
     * @summary Get a list of mints
     * @param {ListMintsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MintsApi
     */
    public listMints(requestParameters: ListMintsRequest = {}, options?: AxiosRequestConfig) {
     ...
     * Mint tokens in a batch with fees
     * @summary Mint Tokens V2
     * @param {MintTokensRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MintsApi
     */
    public mintTokens(requestParameters: MintTokensRequest, options?: AxiosRequestConfig) {
