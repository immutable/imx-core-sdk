...
export class DepositsApi extends BaseAPI {
     ...
     * Get details of a deposit with the given ID
     * @summary Get details of a deposit with the given ID
     * @param {GetDepositRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DepositsApi
     */
    public getDeposit(requestParameters: GetDepositRequest, options?: AxiosRequestConfig) {
     ...
     * Gets details of a signable deposit
     * @summary Gets details of a signable deposit
     * @param {GetSignableDepositRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DepositsApi
     */
    public getSignableDeposit(requestParameters: GetSignableDepositRequest, options?: AxiosRequestConfig) {
     ...
     * Get a list of deposits
     * @summary Get a list of deposits
     * @param {ListDepositsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DepositsApi
     */
    public listDeposits(requestParameters: ListDepositsRequest = {}, options?: AxiosRequestConfig) {
